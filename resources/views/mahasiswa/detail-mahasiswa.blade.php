            ...
            <div class=" ">
                <div class="p-4 mt-2 mb-2 d-flex flex-column align-items-center ">
                    <div class="row d-flex justify-content-center gap-2" style="padding: 0;">
                        <div class="gambar-kiri col-6 d-flex " style="background-image:url('{{ asset('card-1.png') }}');
                            ...
                            overflow:hidden; border:clamp(3px,0.4vw, 6px) solid black; align-self:flex-end">
                                <img class="img-fluid;" src="{{ asset('storage/'.$mahasiswa->foto) }}">
                            </div>
                        </div>
                        <div class="data-kanan col-6 d-flex flex-column gap-2" style="width: clamp(300px,38.4vw, 468px);background-color: white;border-radius: 55px;padding:20px; ">
